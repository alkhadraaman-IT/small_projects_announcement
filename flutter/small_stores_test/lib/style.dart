...
TextStyle  style_text_button_normal (Color c) => TextStyle(color: c, fontSize: 16);//  fontFamily: font);
TextStyle  style_text_button_normal_2(Color c) => TextStyle(color: c, fontSize: 16);// fontFamily: font);
var style_text_button_normal_red = TextStyle(color: Colors.red, fontSize: 16, );// fontFamily: font);
...
var style_text_titel = TextStyle(fontSize: 22, fontWeight: FontWeight.bold);//, fontFamily: font );
