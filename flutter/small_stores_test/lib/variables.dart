...
//CustomDrawer
const String a_main_page_d ="الصفحة الرئيسية";
const String a_about_app_d ='حول التطبيق';
const String a_favort_d ="المفضلة";
const String a_ann_d ="الإعلانات";
const String a_logout_d ="تسجيل الخروج";
const String a_profile_d ="ملف الشخصي";
const String a_app_out_d ="خروج من التطبيق";
