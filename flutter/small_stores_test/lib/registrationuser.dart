...
class _RegistratiOnUser extends State<RegistratiOnUser> {
  ...
  void _loadUsers() async {
    try {
      ...
      setState(() {
        _errorMessage = a_data_loading_error;
        _isLoading = false;
      });
    }
  }
...
// دالة لتحويل رابط الصورة إذا كان نسبي أو كامل
  String getImageUrl(String? url) {
    if (url == null || url.isEmpty) return '';
    if (!url.startsWith('http')) {
      // الرابط نسبي، نضيف baseUrlImg
          ...
          children: [
            ...
            if (_isLoading)
              ...
              Expanded(
                ...
                Expanded(
                  child: Center(child: Text(a_no_users_found )),
                )
              else
                Expanded(
                              ...
                              Container(
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                    image: (user.profile_photo != null && user.profile_photo!.isNotEmpty)
