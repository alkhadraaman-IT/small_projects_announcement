                  ...
                  Expanded(
                    child: GridView.builder(
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                        ...
                        crossAxisSpacing: 16,
                        mainAxisSpacing: 16,
                        childAspectRatio: 1.2, // أو استخدم _getChildAspectRatio(context)
                      ),
                      ...
                      itemBuilder: (context, index) {
                        ...
                        // إصلاح رابط الصورة
                        String fixedProductImage = product.product_photo_1;
                        if (fixedProductImage.contains('http://127.0.0.1:8000/storage/http://127.0.0.1:8000/storage/')) {
                          fixedProductImage = fixedProductImage.replaceAll(
                            'http://127.0.0.1:8000/storage/http://127.0.0.1:8000/storage/',
                            ApiService.baseUrlImg,
                          );
                        } else if (fixedProductImage.contains('http://127.0.0.1:8000/storage/')) {
                          fixedProductImage = fixedProductImage.replaceFirst(
                                ...
                                Container(
                                  decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                      image: NetworkImage(fixedProductImage),
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                ),
